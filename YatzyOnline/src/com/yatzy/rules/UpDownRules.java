...
public class UpDownRules extends GameRules{

	int[][] upDownOrderOfPlay;
	...
	public UpDownRules() {
		...
		setNbrOfDices(5);
		setNbrOfTurns(15);
		upDownOrderOfPlay = new int[15][15];
		setOOP();
		setOrderOfPlay(upDownOrderOfPlay);
	...
	public void setOOP() {
		for (int i = 0; i<15; i++) {
			for (int j = 0; j < 15; j++) {
				upDownOrderOfPlay[i][j] = 0;
			}
			upDownOrderOfPlay[i][i] = 1;
		}
	...
	public int[] getTurnRules(int turn) {
		return this.upDownOrderOfPlay[turn]; //need to be picked out of the orderOfPlayMatrix based on the indata turn
	}
	*/
}
